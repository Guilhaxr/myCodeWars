// Imagine two rings with numbers on them. The inner ring spins clockwise 
// (decreasing by 1 each spin) and the outer ring spins counter clockwise (increasing by 1 each spin).
